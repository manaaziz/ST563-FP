...
Based on cross validation, the random forest model for regression using two randomly-selected variables considered at each split was selected. This model produced a test error rate of `r round(rf.reg.test_err,4)`.  
